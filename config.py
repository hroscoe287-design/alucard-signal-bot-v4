...
# Current community clients use Socket.IO over Engine.IO v4 on po.market
# regional endpoints. EU is the default; the feed will use the selected
# endpoint without exposing credentials in source control.
REGION_URLS = {
